...
Updated to add autocomplete functionality with bootstrap.typeahead.js

And to remove styling to allow css to handle 
		...
		this.each(function() { 
			...
			if (settings.interactive) { 
				...
				if (settings.autocomplete_url != undefined) {
					...
					} else if($.fn.typeahead !== undefined){
						autocomplete_options.updater = function(item){
							$(data.real_input).addTag(item,{focus:true,unique:(settings.unique)});
						}
